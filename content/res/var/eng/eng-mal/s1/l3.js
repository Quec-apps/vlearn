...
window[t+"-msg"+k] = "മൃഗങ്ങളെക്കുറിച്ചുള്ള പുതിയ വാക്കുകൾ പഠിക്കാൻ തുടങ്ങാം."; //message
...
window[t+"-n"+k] = "Peacock"; window[t+"-n-m"+k] = "മയിൽ"; //n means new words, n-m means new word's meaning
...
window[t+"-n"+k] = "Rat"; window[t+"-n-m"+k] = "എലി"; //n means new words, n-m means new word's meaning
window[t+"-o1"+k] = "Cow"; window[t+"-l1-"+k] = "/level3/cow.png"; window[t+"-m1-"+k] = "eng/unit3/cow.mp3";
window[t+"-o2"+k] = "Peacock"; window[t+"-l2-"+k] = "/level3/peacock.png"; window[t+"-m2-"+k] = "eng/unit3/peacock.mp3";
window[t+"-o3"+k] = "Rat"; window[t+"-l3-"+k] = "/level3/rat.png"; window[t+"-m3-"+k] = "eng/unit3/rat.mp3";
window[t+"-o4"+k] = "Dog"; window[t+"-l4-"+k] = "/level3/dog.png"; window[t+"-m4-"+k] = "eng/unit3/dog.mp3";
...
window[t+"-n"+k] = "Grass"; window[t+"-n-m"+k] = "പുല്ല്"; //n means new words, n-m means new word's meaning
window[t+"-o1"+k] = "Horse"; window[t+"-l1-"+k] = "/level3/horse.png"; window[t+"-m1-"+k] = "eng/unit3/horse.mp3";
window[t+"-o2"+k] = "Peacock"; window[t+"-l2-"+k] = "/level3/peacock.png"; window[t+"-m2-"+k] = "eng/unit3/peacock.mp3";
window[t+"-o3"+k] = "Pigeon"; window[t+"-l3-"+k] = "/level3/pigeon.png"; window[t+"-m3-"+k] = "eng/unit3/pigeon.mp3";
window[t+"-o4"+k] = "Grass"; window[t+"-l4-"+k] = "/level3/grass.png"; window[t+"-m4-"+k] = "eng/unit3/grass.mp3";
...
window[t+"-msg"+k] = "ഈ യൂണിറ്റിൽ നിങ്ങൾ ഇതുവരെ പഠിച്ചത് എന്താണെന്ന് നോക്കാം."; //message

k++;
window[t+"-type"+k] = "conversation"; xt=0;
xt++;window[t+"-q"+xt+"-l"+k] = "Horse"; window[t+"-t"+xt+"-l"+k] = "കുതിര"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/horse.mp3'; //l=left,r=right q=ques,t=translated, m=music
xt++;window[t+"-q"+xt+"-l"+k] = "Peacock"; window[t+"-t"+xt+"-l"+k] = "മയിൽ"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/peacock.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "Pigeon"; window[t+"-t"+xt+"-l"+k] = "പ്രാവ്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/pigeon.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "Elephant"; window[t+"-t"+xt+"-l"+k] = "ആന"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/elephant.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "Cow"; window[t+"-t"+xt+"-l"+k] = "പശു"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/cow.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "Rat"; window[t+"-t"+xt+"-l"+k] = "എലി"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/rat.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "Dog"; window[t+"-t"+xt+"-l"+k] = "നായ"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/dog.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "Bird"; window[t+"-t"+xt+"-l"+k] = "പക്ഷി"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/bird.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "Grass"; window[t+"-t"+xt+"-l"+k] = "പുല്ല്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/grass.mp3';
window[t+"-len"+k]=xt;

k++;
window[t+"-type"+k] = "message";
window[t+"-ti"+k] = "പുതിയ വാക്കുകൾ"; //title
window[t+"-msg"+k] = "ഒന്ന് മുതൽ പത്ത് വരെയുള്ള അക്കങ്ങൾ പഠിക്കാം."; //message
...
window[t+"-type"+k] = "message";
window[t+"-ti"+k] = "പഠിച്ച വാക്കുകൾ"; //title
window[t+"-msg"+k] = "Lets see what you have learned in this unit so far."; //message

k++;
window[t+"-type"+k] = "conversation"; xt=0;
xt++;window[t+"-q"+xt+"-l"+k] = "one"; window[t+"-t"+xt+"-l"+k] = "ഒന്ന്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/1.mp3'; //l=left,r=right q=ques,t=translated, m=music
xt++;window[t+"-q"+xt+"-l"+k] = "two"; window[t+"-t"+xt+"-l"+k] = "രണ്ട്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/2.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "three"; window[t+"-t"+xt+"-l"+k] = "മൂന്ന്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/3.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "four"; window[t+"-t"+xt+"-l"+k] = "നാല്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/4.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "five"; window[t+"-t"+xt+"-l"+k] = "അഞ്ച്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/5.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "six"; window[t+"-t"+xt+"-l"+k] = "ആറ്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/6.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "seven"; window[t+"-t"+xt+"-l"+k] = "ഏഴ്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/7.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "eight"; window[t+"-t"+xt+"-l"+k] = "എട്ട്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/8.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "nine"; window[t+"-t"+xt+"-l"+k] = "ഒമ്പത്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/9.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "ten"; window[t+"-t"+xt+"-l"+k] = "പത്ത്"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/10.mp3';
window[t+"-len"+k]=xt;
...
k++;
window[t+"-type"+k] = "message";
window[t+"-ti"+k] = "ഏകവചനവും ബഹുവചനവും പഠിക്കാം"; //title
window[t+"-msg"+k] = `
ഏകവചനം(Singular) എന്നർത്ഥം ഒന്ന്.<br/>ബഹുവചനം(Plural) എന്നാൽ ഒന്നിൽ കൂടുതൽ.
<br/><br/>
ഉദാഹരണം:<br/>
ഏകവചനം: <strong>one dog</strong><br/>
ബഹുവചനം: <strong>five dogs</strong>
<br/><br/>
ഏകവചനം: <strong>one rat</strong><br/>
ബഹുവചനം: <strong>two rats</strong>
<br/><br/>
മിക്ക ബഹുവചന നാമങ്ങളും 's' അല്ലെങ്കിൽ 'es' ൽ അവസാനിക്കുന്നു.<br/>
ഉദാഹരണം:<br/>dog<strong>s</strong>, rat<strong>s</strong>, grass<strong>es</strong>
<br/>
<a href="https://www.youtube.com/watch?v=uzp1lu9hClU">കൂടുതലറിയുക</a>
`; //message
...
k++;
window[t+"-type"+k] = "mcq";
window[t+"-q"+k] = "പത്ത് പ്രാവുകൾ"; window[t+"-m"+k] = null; //m is music
window[t+"-l"+k] = 2; //how many options are there
...
k++;
window[t+"-type"+k] = "message";
window[t+"-ti"+k] = "പഠിച്ച കാര്യങ്ങൾ"; //title
window[t+"-msg"+k] = `
നിങ്ങൾ ഇംഗ്ലീഷിൽ ഏകവചനവും ബഹുവചനവും പഠിച്ചു.
<br/>
<a href="https://www.youtube.com/watch?v=uzp1lu9hClU">കൂടുതലറിയുക</a>
`; //message
...
k++;
window[t+"-type"+k] = "word";
window[t+"-q"+k] = "Animal"; window[t+"-m"+k] = "eng/unit3/animal.mp3"; //m is music
window[t+"-o1"+k] = "ആന";
window[t+"-o2"+k] = "പ്രാവ്";
window[t+"-o3"+k] = "മയിൽ";
window[t+"-o4"+k] = "മൃഗം";
...
k++;
window[t+"-type"+k] = "word";
window[t+"-q"+k] = "മൃഗം"; window[t+"-m"+k] = null; //m is music
window[t+"-o1"+k] = "elephant";
window[t+"-o2"+k] = "animal";
window[t+"-o3"+k] = "rat";
window[t+"-o4"+k] = "pigeon";
window[t+"-ans"+k] = 2;
...
k++;
window[t+"-type"+k] = "conversation"; xt=0;
xt++;window[t+"-q"+xt+"-l"+k] = "Is your house big or small?"; window[t+"-t"+xt+"-l"+k] = "നിങ്ങളുടെ വീട് വലുതാണോ ചെറുതാണോ?"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/is-your-house-big-or-small.mp3'; //l=left,r=right q=ques,t=translated, m=music
xt++;window[t+"-q"+xt+"-r"+k] = "My house is small."; window[t+"-t"+xt+"-r"+k] = "എൻ്റെ വീട് ചെറുതാണ്."; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/my-house-is-small.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "Is that a bird?"; window[t+"-t"+xt+"-l"+k] = "അത് ഒരു പക്ഷി ആണോ?"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/is-that-a-bird.mp3';
xt++;window[t+"-q"+xt+"-r"+k] = "Yes, three pigeons and seven peacocks."; window[t+"-t"+xt+"-r"+k] = "അതെ, മൂന്ന് പ്രാവുകളും ഏഴ് മയിലുകളും."; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/yes-three-pigeons-and-seven-peacocks.mp3';
xt++;window[t+"-q"+xt+"-l"+k] = "Is this tea cold or hot?"; window[t+"-t"+xt+"-l"+k] = "ഈ ചായ തണുത്തതോ ചൂടുള്ളതോ?"; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/is-this-tea-cold-or-hot.mp3';
xt++;window[t+"-q"+xt+"-r"+k] = "It is a hot tea."; window[t+"-t"+xt+"-r"+k] = "ഇത് ഒരു ചൂടുള്ള ചായ ആണ്."; window[t+"-q"+xt+"-m"+k] = 'eng/unit3/it-is-a-hot-tea.mp3';
window[t+"-len"+k]=xt;
